...
import (
	...
	systemRes "achilles/model/system/response"
	"achilles/utils"
...
// @Tags AuthorityMenu
// @Summary 增加 menu 和角色关联关系
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body systemReq.AddMenuAuthorityInfo true "角色 ID"
...
// @accept application/json
// @Produce application/json
// @Param data body request.GetAuthorityId true "角色 ID"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data body system.SysBaseMenu true "路由 path，父菜单 ID，路由 name，对应前端文件路径，排序标记"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"添加成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data body request.GetById true "菜单 id"
