...
func (c *casbin) Initialize() error {
	entities := []adapter.CasbinRule{
		...
		{PType: "p", V0: "888", V1: "/sysDictItem/findSysDictItem", V2: "GET"},
		{PType: "p", V0: "888", V1: "/sysDictItem/updateSysDictItem", V2: "PUT"},
		{PType: "p", V0: "888", V1: "/sysDictItem/createSysDictItem", V2: "POST"},
		{PType: "p", V0: "888", V1: "/sysDictItem/getSysDictItems", V2: "GET"},
		{PType: "p", V0: "888", V1: "/sysDictItem/deleteSysDictItem", V2: "DELETE"},

		{PType: "p", V0: "888", V1: "/sysDict/findSysDict", V2: "GET"},
		{PType: "p", V0: "888", V1: "/sysDict/updateSysDict", V2: "PUT"},
		{PType: "p", V0: "888", V1: "/sysDict/getSysDicts", V2: "GET"},
		{PType: "p", V0: "888", V1: "/sysDict/createSysDict", V2: "POST"},
		{PType: "p", V0: "888", V1: "/sysDict/deleteSysDict", V2: "DELETE"},
