...
const (
	startComment = "Code generated by achilles Begin; DO NOT EDIT."
	endComment   = "Code generated by achilles End; DO NOT EDIT."
)
...
func AutoInjectionCode(filepath string, funcName string, codeData string) error {
	...
	// 在指定函数名，且函数中 startComment 和 endComment 都存在时，进行区间查重
