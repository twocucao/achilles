...
import (
	...
	exampleRes "achilles/model/example/response"
	"achilles/utils"
...
// @accept application/json
// @Produce application/json
// @Param data body example.ExaCustomer true "客户 ID"
...
// @accept application/json
// @Produce application/json
// @Param data body example.ExaCustomer true "客户 ID，客户信息"
...
// @accept application/json
// @Produce application/json
// @Param data query example.ExaCustomer true "客户 ID"
